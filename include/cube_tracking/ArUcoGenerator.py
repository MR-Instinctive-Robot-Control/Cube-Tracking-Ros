...
def generateArUcoMarker(dict_to_use, id, dir_path, visualize=True):
	# generatethe marker
	...
	file_path = dir_path + '/tag/tag_' + dict_to_use + '/'
...
if __name__ == '__main__':
	...
	dict_to_use, visualize, grey_color, id = readConfig(dir_path+'/config.json')
	generateArUcoMarker(dict_to_use, id, dir_path, visualize=False)
